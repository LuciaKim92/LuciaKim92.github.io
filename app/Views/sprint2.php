                                        ...
                                        <div class="m-portlet m-portlet--full-height  m-portlet--unair">
                                            <div class="m-portlet__body" style="padding:0px">
                                                <table class="table table-bordered" id="sprint-table">
                                                    <tbody>
                                                        <tr>
                                                            <th scope="row" style="width:auto">부분(본부)/팀</th>
                                                            <th>경영기획부분/IT혁신팀</th>
                                                        </tr>
                                                    </tbody>
                                                </table>                                                
                                            ...
                                            <table class="table table-bordered" id="sprint-table">
                                                    <tbody>
                                                        ...
                                                        <tr style="background-color:#dae8fc">
                                                            <th scope="col" style="width:10%">KR</th>
                                                            <th scope="col" style="width:10%">담당자</th>
                                                            <th scope="col" stlye="width:40%">지난주 한 일</th>
                                                            <th scope="col" stlye="width:40%">피드백</th>
                                                        </tr>
                                                        
                                                        <tbody id="feedback-kr-1">
                                                            <tr>
                                                                <th id="feedback-kr-1-head" rowspan="6">
                                                                    Key Result 1
                                                                    <button type="button" id="btn1" onclick="add_colum('feedback-kr-1')">+</button>
                                                                </th>   
                                                                <td rowspan="2"></td>
                                                        ...
                                                        <tbody id="feedback-kr-2">
                                                            <tr>
                                                                <th id="feedback-kr-2-head" rowspan="6">
                                                                    Key Result 2
                                                                    <button type="button" id="btn1" onclick="add_colum('feedback-kr-2')">+</button>
                                                                </th>
                                                                <td rowspan="2"></td>
                                                                <td rowspan="2">[다음주 할 일 연동]</td>
                                                                <td>High)</td>
                                                        ...
                                                        <tbody id="feedback-kr-3">
                                                            <tr>
                                                                <th id="feedback-kr-3-head" rowspan="6">
                                                                    Key Result 3
                                                                    <button type="button" id="btn1" onclick="add_colum('feedback-kr-3')">+</button>
                                                                </th>
                                                                <td rowspan="2"></td>
                                                                <td rowspan="2">[다음주 할 일 연동]</td>
                                                                <td>High)</td>
                                                    ...
                                                    <tbody>
                                                        <tr style="background-color:#ffccc9">
                                                            <th>KR</th>
                                                            <th>담당자</th>
                                                            <th>Initiatives(전략)</th>
                                                            <th>아이디어</th>
                                                        </tr>

                                                        <tbody id="idea-kr-1">
                                                            <tr>
                                                                <th rowspan="2" id="idea-kr-1-head">
                                                                    Key Result 1
                                                                    <button type="button" id="btn1" onclick="add_colum2('idea-kr-1')">+</button>
                                                                </th>
                                                                <td></td>
                                                        ...
                                                        <tbody id="idea-kr-2">
                                                            <tr>
                                                                <th rowspan="2" id="idea-kr-2-head">
                                                                    Key Result 2
                                                                    <button type="button" id="btn1" onclick="add_colum2('idea-kr-2')">+</button>
                                                                </th>
                                                                <td></td>
                                                                <td>initiative 및 to do list</td>
                                                                <td>[아이디어]</td>
                                                        ...
                                                        <tbody id="idea-kr-3">
                                                            <tr>
                                                                <th rowspan="2" id="idea-kr-3-head">
                                                                    Key Result 3
                                                                    <button type="button" id="btn1" onclick="add_colum2('idea-kr-3')">+</button>
                                                                </th>
                                                                <td></td>
                                                                <td>initiative 및 to do list</td>
                                                                <td>[아이디어]</td>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tbody id="plan-kr-1">
                                                            <tr>
                                                                <th rowspan="3" id="plan-kr-1-head">
                                                                    Key Result 1
                                                                    <button type="button" id="btn1" onclick="add_colum3('plan-kr-1')">+</button>
                                                                </th>
                                                                <td>담당자 이름</td>
                                                                <td colspan="2">할 일</td>
                                                            </tr>
                                                        ...
                                                        <tbody id="plan-kr-2">
                                                            <tr>
                                                                <th rowspan="3" id="plan-kr-2-head">
                                                                    Key Result 2
                                                                    <button type="button" id="btn1" onclick="add_colum3('plan-kr-2')">+</button>
                                                                </th>
                                                                <td>담당자 이름</td>
                                                                <td colspan="2">할 일</td>
                                                            </tr>
                                                        ...
                                                        <tbody id="plan-kr-3">
                                                            <tr>
                                                                <th rowspan="3" id="plan-kr-3-head">
                                                                    Key Result 3
                                                                    <button type="button" id="btn1" onclick="add_colum3('plan-kr-3')">+</button>
                                                                </th>
                                                                <td>담당자 이름</td>
                                                                <td colspan="2">할 일</td>
                                                            </tr>

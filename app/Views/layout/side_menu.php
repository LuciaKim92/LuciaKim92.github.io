				...
				<div id="m_aside_left" class="m-grid__item	m-aside-left  m-aside-left--skin-dark ">
					...
					<div id="m_ver_menu" class="m-aside-menu  m-aside-menu--skin-dark m-aside-menu--submenu-skin-dark " m-menu-vertical="1" m-menu-scrollable="0" m-menu-dropdown-timeout="500">
						<ul class="m-menu__nav ">
							...
							<li id = "okr_map_left_menu" class="m-menu__item " aria-haspopup="true" m-menu-link-redirect="1"><a href="./okrmap" class="m-menu__link "><span class="m-menu__item-here"></span><span class="m-menu__link-text"><img src="/assets/icon/okr_map_icon.png" height="15" width="15">&nbsp;&nbsp;OKR Map</span></a></li>

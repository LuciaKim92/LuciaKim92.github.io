    ...
    $("#m_sweetalert_demo_1").click(function (e) {
      ...
      $("#m_sweetalert_demo_5").click(function (e) {
        swal({
          ...
          icon: "success",
          confirmButtonText:
            "<span><i class='la la-headphones'></i><span>I am game!</span></span>",
          confirmButtonClass:
            "btn btn-danger m-btn m-btn--pill m-btn--air m-btn--icon",
          showCancelButton: !0,
          cancelButtonText:
            "<span><i class='la la-thumbs-down'></i><span>No, thanks</span></span>",
      ...
      $("#m_sweetalert_demo_8").click(function (e) {
        ...
        swal({
          ...
          e.value && swal("검수 요청이 완료되었습니다.", "", "success");
        });
      }),
      $("#m_sweetalert_demo_9").click(function (e) {
        e.preventDefault();
        swal({
          title: "OKR 사례를 등록하시겠습니까?",
          text: "",
          type: "warning",
          showCancelButton: !0,
          confirmButtonText: "예",
